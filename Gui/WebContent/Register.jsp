      ...
      <section class="wrapper">
        <div class="row">
		  ...
		  <div class="page-header-register">
            <h3 class="page-header"><i>REGISTER USER</i></h3>
			</div></div>
			<div class="col-lg-1">
              <a href="WelcomePage.jsp"><button class="btn btn-primary btn-lg btn-block" type="submit">HOME</button></a>
          </div>
        </div>
      </section>
  ...
  <form action="RegisterServlet">
	...
	<div class="container">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-1">
                    <input type="radio" class="form-control" name="gender" value="Male" checked>Male
				</div>
				<div class="col-sm-1">
        ...
        <div class="form-group">
		   ...
		   <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <input type="password" class="form-control" name="confpassword" value="${confpassword}" required>
                </div>
            </div>
        </div>
        <div class="form-group">
		   ...
		   <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <input type="number" class="form-control" name="contact" value="${contact}" required>
                </div>
            </div>
        </div>
        <div class="form-group">
