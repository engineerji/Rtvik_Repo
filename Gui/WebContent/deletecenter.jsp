  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-11">
            <h3 class="page-header"><i class="fa fa-user-md"></i>DELETE CENTER</h3>
			</div>
			<div>
		...
		<%
			...
			while(iterator.hasNext())
			{
				...
				<tr>
					...
					<td><a href = "DeleteCenterServlet?id=<%=dc.getCenterId()%>"> <div class="row">
                <button type="submit" name="deletecenter" class="btn btn-primary" >Delete</button>
            </td>
				</tr>
			<%
			}
