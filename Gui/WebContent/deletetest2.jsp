		...
		<thead class="tablehead">
			...
			%>
				<tr>
					<td><%=t.getTestid()%></td>
					<td><%=t.getName()%></td>
					<td><a href = "DeleteTestServlet?id=<%=request.getAttribute("dcid")%>&tid=<%=t.getTestid()%>&tname=<%=t.getName()%>"><input type="button" class="btn btn-info" value="DELETE"  name="deleteTest"></a></td>
				</tr>
			<%		
				}
			%>
