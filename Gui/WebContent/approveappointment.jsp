		...
		<%
			...
			while(iterator.hasNext())
			{
				...
				<tr>
					...
					<td><a href ="ViewAppointServlet?id=<%=dc.getCenterId()%>&flag=1&"><div class="row">
                <div class="col-sm-3"><button type="submit" name="selectCenter" class="btn btn-info" >SELECT</button></div></a></td>
				</tr>
			<%
			}
		%>
